...
public class Main {
	...
	public static void main(String[] args) {
		...
		someCheckingAccounts[0] = new CheckingAccount("231-471", 25.00, 100d);
		someCheckingAccounts[1] = new CheckingAccount("446-973", 25.00, 200d);
		Account[] someSavingsAccounts = new SavingsAccount[3];
		someSavingsAccounts[0] = new SavingsAccount("44-8123", 0.03, 200d);
		someSavingsAccounts[1] = new SavingsAccount("21-9672", 0.03, 200d);
		someSavingsAccounts[2] = new SavingsAccount("68-0902", 0.04, 600d);
